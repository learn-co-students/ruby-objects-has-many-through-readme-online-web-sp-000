...
describe "Object relationships" do
  ...
  describe "Waiter" do
    ...
    describe "#most_frequent_customer" do
      it "returns the Customer instance associated that has had the most meals with a waiter" do
        howard = Customer.new("Howard", 30)
        daniel = Customer.new("Daniel", 30)
        lisa = Customer.new("Lisa", 27)
         terrance = Waiter.new("Terrance", 1)
        ...
        lisa.new_meal(terrance, 15, 4)
        lisa.new_meal(terrance, 15, 5)
        howard.new_meal(terrance, 15, 1)
        howard.new_meal(terrance, 15, 3)
        daniel.new_meal(terrance, 15, 3)
    ...
    describe "#average_tip" do
      it "returns the average amount of tips for a waiter " do
        howard = Customer.new("Howard", 30)
        daniel = Customer.new("Daniel", 30)
        lisa = Customer.new("Lisa", 27)
        josh = Customer.new("Josh", 31)
        ...
        expect(terrance.average_tip).to eq(3)
      end
    end
  end
end
